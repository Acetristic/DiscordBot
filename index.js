...
modules.forEach(function(module) {
  fs.readdir(`./commands/${module}`, function(err, files) {
    if (err)
      return new Error(
        "Oops, missing folder of commands! Example: Commands/<Folder>/<Command>.js"
      );
  ...
  if (command) {
    if (!message.guild.me.hasPermission("ADMINISTRATOR"))
      return message.channel.send(
        "Welp, I don't have the perms to use any of my commands. Required role: ADMINISTRATOR."
      );
...
//Bot coded by Acetristic#0001, don't share without credits!
